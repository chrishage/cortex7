...
SELECT
  ...
  CAST(NULL AS STRING) AS dtuc_status_sapmp_lbask,
  ...
  CAST(NULL AS STRING) AS loading_units_bev1_luleinh,
  CAST(NULL AS STRING) AS number_category_1_bev1_rpfaess,
  CAST(NULL AS STRING) AS number_category_2_bev1_rpkist,
  CAST(NULL AS STRING) AS number_category_3_bev1_rpcont,
  CAST(NULL AS STRING) AS number_category_4_bev1_rpsonst,
  CAST(NULL AS STRING) AS tour_loading_sequqnce_number_bev1_rpflgnr,
