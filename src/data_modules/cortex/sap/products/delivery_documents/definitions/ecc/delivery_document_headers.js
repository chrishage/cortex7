...
SELECT
  ...
  TIMESTAMP(DATETIME(DATE '1970-01-01', likp.erzet)) AS creation_time_erzet,
  ...
  TIMESTAMP(DATETIME(DATE '1970-01-01', likp.lfuhr)) AS delivery_time_lfuhr,
  ...
  TIMESTAMP(DATETIME(DATE '1970-01-01', likp.kouhr)) AS picking_time_kouhr,
  TIMESTAMP(DATETIME(DATE '1970-01-01', likp.tduhr)) AS transportation_planning_time_tduhr,
  TIMESTAMP(DATETIME(DATE '1970-01-01', likp.lduhr)) AS loading_time_lduhr,
  TIMESTAMP(DATETIME(DATE '1970-01-01', likp.wauhr)) AS goods_issue_time_wauhr,
  ...
  TIMESTAMP(DATETIME(DATE '1970-01-01', likp.potim)) AS proof_of_delivery_confirmation_time_potim,
  ...
  TIMESTAMP(DATETIME(DATE '1970-01-01', likp.spe_wauhr_ist)) AS goods_issue_time_spe_wauhr_ist,
  ...
  TIMESTAMP(DATETIME(DATE '1970-01-01', likp.handovertime)) AS handover_time_handovertime,
