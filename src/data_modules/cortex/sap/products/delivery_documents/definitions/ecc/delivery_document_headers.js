...
SELECT
  ...
  CAST(NULL AS STRING) AS loading_unit_of_measure_bev1_luleinh,
  CAST(NULL AS STRING) AS number_category_1_rpfaess,
  CAST(NULL AS STRING) AS number_category_2_rpkist,
  CAST(NULL AS STRING) AS number_category_3_rpcont,
  CAST(NULL AS STRING) AS number_category_4_rpsonst,
  CAST(NULL AS STRING) AS loading_sequence_number_rpflgnr,
