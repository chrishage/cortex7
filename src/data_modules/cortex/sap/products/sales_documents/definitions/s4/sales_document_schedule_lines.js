...
SELECT
  ...
  TIMESTAMP(DATETIME(DATE '1970-01-01', vbep.ezeit)) AS arrival_time_ezeit,
  ...
  TIMESTAMP(DATETIME(DATE '1970-01-01', vbep.mbuhr)) AS material_staging_time_mbuhr,
  TIMESTAMP(DATETIME(DATE '1970-01-01', vbep.tduhr)) AS transp_planning_time_tduhr,
  TIMESTAMP(DATETIME(DATE '1970-01-01', vbep.lduhr)) AS loading_time_lduhr,
  TIMESTAMP(DATETIME(DATE '1970-01-01', vbep.wauhr)) AS time_of_goods_issue_wauhr,
  vbep.aulwe AS route_schedule_aulwe,
  vbep.handoverdate AS handover_date_at_the_handover_location_handoverdate,
  TIMESTAMP(DATETIME(DATE '1970-01-01', vbep.handovertime)) AS handover_time_at_the_handover_location_handovertime,
