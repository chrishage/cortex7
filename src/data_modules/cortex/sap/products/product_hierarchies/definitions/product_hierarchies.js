...
SELECT
  ...
  t179.prodh AS product_hierarchy_prodh,
  t179t.spras AS language_key_spras,
  t179.stufe AS level_number_stufe,
...
FROM
  ${ctx.ref(moduleConfig.sources.sapModule.datasetId, 't179')} AS t179
INNER JOIN
  ${ctx.ref(moduleConfig.sources.sapModule.datasetId, 't179t')} AS t179t
  ON t179.mandt = t179t.mandt
  AND t179.prodh = t179t.prodh
${sql_helper.buildDynamicWhere([
  incremental.getFilter(ctx, ["t179", "t179t"])
])}
`
);
