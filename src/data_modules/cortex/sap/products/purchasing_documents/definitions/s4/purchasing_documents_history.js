...
SELECT
  ...
  ekbe.tax_country AS tax_country,
  ...
  ekbe.sesuom AS ses_unit_of_measure_sesuom,
  ekbe.logsy AS logical_system_logsy,
  ekbe.et_upd AS slqupd_et_upd,
  CAST(NULL AS STRING) AS quantity_in_parallel_uom_cwm_bamng,
  CAST(NULL AS STRING) AS gr_blocked_stock_in_base_parallel_uom_cwm_wesbs,
  CAST(NULL AS STRING) AS puom_type_cwm_ty2tq,
  CAST(NULL AS STRING) AS gr_blkd_stk_in_basis_or_parallel_uom_cwm_wesbb,
  ...
  ekbe.qty_diff AS quantity_quantity_diff,
