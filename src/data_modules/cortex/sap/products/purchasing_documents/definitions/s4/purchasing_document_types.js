...
SELECT
  ...
  CAST(NULL AS STRING) AS fastdataentry_of_chars_is_active_sapmp_ceact,
  CAST(NULL AS STRING) AS inheritance_is_activated_sapmp_pdact,
  CAST(NULL AS STRING) AS inheritance_log_sapmp_pprot,
  CAST(NULL AS STRING) AS inheritance_overwrite_user_values_sapmp_puser,
  CAST(NULL AS STRING) AS inheritance_of_char_selection_list_sapmp_pausw,
  CAST(NULL AS STRING) AS characteristic_name_sapmp_atnam,
  CAST(NULL AS STRING) AS global_local_group_may_be_undone_sapmp_gauf,
