...
publish("purchase_documents_history", { ...publishConfig, name: "PurchaseDocumentsHistory" }).query(
  (ctx) => `
...
LEFT JOIN ${ctx.ref(moduleConfig.sources.sapMasterData.datasetId, 'calendar_date_dim')} AS CalendarDateDimension_BUDAT
