...
publish("purchase_documents", { ...publishConfig, name: "PurchaseDocuments" }).query(
  (ctx) => `
...
SELECT
  ...
  CalendarDateDimension_AEDAT.cal_year AS YearOfChangeDate_AEDAT,
  CalendarDateDimension_AEDAT.cal_month AS MonthOfChangeDate_AEDAT,
  CalendarDateDimension_AEDAT.cal_week AS WeekOfChangeDate_AEDAT,
  CalendarDateDimension_AEDAT.cal_quarter AS QuarterOfChangeDate_AEDAT,
  CalendarDateDimension_BEDAT.cal_year AS YearOfPurchasingDocumentDate_BEDAT,
  CalendarDateDimension_BEDAT.cal_month AS MonthOfPurchasingDocumentDate_BEDAT,
  CalendarDateDimension_BEDAT.cal_week AS WeekOfPurchasingDocumentDate_BEDAT,
  CalendarDateDimension_BEDAT.cal_quarter AS QuarterOfPurchasingDocumentDate_BEDAT,
...
FROM ${ctx.ref(moduleConfig.sources.sapModule.datasetId, 'ekpo')} AS ekpo
INNER JOIN ${ctx.ref(moduleConfig.sources.sapModule.datasetId, 'ekko')} AS ekko
...
LEFT JOIN calendar_date_dim AS CalendarDateDimension_AEDAT
