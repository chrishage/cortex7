...
SELECT
  ...
  TIMESTAMP(DATETIME(DATE '1970-01-01', EKES.EZEIT)) AS TimeAtWhichVendorConfirmationWasCreated_EZEIT,
  ...
  TIMESTAMP(DATETIME(DATE '1970-01-01', EKES.HANDOVERTIME)) AS HandoverTimeAtTheHandoverLocation_HANDOVERTIME,
