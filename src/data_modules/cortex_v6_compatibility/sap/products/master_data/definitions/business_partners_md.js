...
publish("business_partners_md", { ...publishConfig, name: "BusinessPartnersMD" }).query(
  (ctx) => `
SELECT
  ...
  TIMESTAMP(DATETIME(DATE '1970-01-01', BUT000.CRTIM)) AS TimeAtWhichTheObjectWasCreated_CRTIM,
  BUT000.CHUSR AS LastUserToChangeObject_CHUSR,
  BUT000.CHDAT AS DateWhenObjectWasLastChanged_CHDAT,
  TIMESTAMP(DATETIME(DATE '1970-01-01', BUT000.CHTIM)) AS TimeAtWhichObjectWasLastChanged_CHTIM,
