...
const publishConfig = publish_config.getPublishConfig(
  ...
  tableConfig,
  moduleConfig,
  ["Client_MANDT", "ChartOfAccounts_KTOPL", "GLAccountNumber_SAKNR"]
);

publish("gl_accounts_md", { ...publishConfig, name: "GLAccountsMD" }).query(
  (ctx) => `
SELECT
...
INNER JOIN ${ctx.ref(moduleConfig.sources.sapModule.datasetId, 'skat')} AS SKAT
