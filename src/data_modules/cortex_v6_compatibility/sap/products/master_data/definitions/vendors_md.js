...
const publishConfig = publish_config.getPublishConfig(
  ...
  tableConfig,
  moduleConfig,
  ["Client_MANDT", "VendorAccountNumber_LIFNR"]
);

publish("vendors_md", { ...publishConfig, name: "VendorsMD" }).query(
  (ctx) => `
SELECT
...
FROM ${ctx.ref(moduleConfig.sources.sapModule.datasetId, 'lfa1')} AS LFA1
INNER JOIN ${ctx.ref(moduleConfig.sources.sapModule.datasetId, 'adrc')} AS ADRC
