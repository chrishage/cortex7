...
publish("deliveries", { ...publishConfig, name: "Deliveries" }).query(
  (ctx) => `
...
(SELECT
  ...
  TIMESTAMP(DATETIME(DATE '1970-01-01', LIKP.ERZET)) AS CreateTime_ERZET,
  ...
  TIMESTAMP(DATETIME(DATE '1970-01-01', LIKP.LFUHR)) AS DeliveryTime_LFUHR,
  ...
  TIMESTAMP(DATETIME(DATE '1970-01-01', LIKP.LFUHR)) AS TimeOfDelivery_LFUHR,
  ...
  TIMESTAMP(DATETIME(DATE '1970-01-01', LIKP.KOUHR)) AS PickingTime_KOUHR,
  TIMESTAMP(DATETIME(DATE '1970-01-01', LIKP.TDUHR)) AS TranspPlanningTime_TDUHR,
  TIMESTAMP(DATETIME(DATE '1970-01-01', LIKP.LDUHR)) AS LoadingTime_LDUHR,
  TIMESTAMP(DATETIME(DATE '1970-01-01', LIKP.WAUHR)) AS TimeOfGoodsIssue_WAUHR,
  ...
  TIMESTAMP(DATETIME(DATE '1970-01-01', LIKP.POTIM)) AS ConfirmationTime_POTIM,
  ...
  TIMESTAMP(DATETIME(DATE '1970-01-01', LIKP.SPE_WAUHR_IST)) AS TimeOfGoodsIssue_Local,
  ...
  TIMESTAMP(DATETIME(DATE '1970-01-01', LIPS.ERZET)) AS EntryTime_ERZET,
  ...
  TIMESTAMP(DATETIME(DATE '1970-01-01', LIPS.MBUHR)) AS MaterialStagingTime_MBUHR,
...
INNER JOIN ${ctx.ref(moduleConfig.sources.sapModule.datasetId, 'likp')} AS LIKP
  ON
...
-- ##CORTEX-CUSTOMER If you prefer to use currency conversion, uncomment and use CurrencyConversion
