...
INNER JOIN ${ctx.ref(moduleConfig.sources.sapModule.datasetId, 'vbup')} AS vbup
...
INNER JOIN ${ctx.ref(moduleConfig.sources.sapModule.datasetId, 'vbuk')} AS vbuk
  ON vbap.MANDT = vbuk.MANDT
