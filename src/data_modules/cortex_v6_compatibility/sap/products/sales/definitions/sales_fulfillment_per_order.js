...
publish("sales_fulfillment_per_order", { ...publishConfig, name: "SalesFulfillment_perOrder" }).query(
  (ctx) => `
WITH
  SO AS (
    SELECT
    ...
    GROUP BY
      SO.Client_MANDT, SO.SalesOrder_VBELV, SO.SalesItem_POSNV,
...
GROUP BY
  ...
  SO.DeliveredUoM_MEINS, SO.DeliveredQty,
